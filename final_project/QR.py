...
def calc_F(V: list[complex]) -> list[list[complex]]:
    ...
    v_multi: list[list[complex]] = LA.matr_matr_multi(V, v_transpose)
...
def cal_Q(identity_matrix: list[list[int]], F: list[list[float]], i: int) -> list[list[float]]:
